...
{
    public class CanvasCardMainSide : CanvasBase
    {
		private Image _image;
        private TMP_Text _TXT_ScientificName;
        private TMP_Text _TXT_CommonName;
        private TMP_Text _TXT_SexStage;
        ...
        public override void Initialize()
        {
            ...
            _TXT_SexStage = transform.Find("TXT_SexStage").GetComponent<TMP_Text>();
        ...
        public override void Populate()
        {
            ...
            _TXT_SexStage.text = coll.Classification.StageSexVar;
