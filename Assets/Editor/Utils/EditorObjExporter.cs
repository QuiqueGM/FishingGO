...
public class EditorObjExporter : ScriptableObject
{
    ...
    [MenuItem("Tools/Export to OBJ/Export all MeshFilters in selection to separate OBJs", false, 20)]
    ...
    [MenuItem("Tools/Export to OBJ/Export whole selection to single OBJ", false, 20)]
    ...
    [MenuItem("Tools/Export to OBJ/Export each selected to single OBJ", false, 20)]
