...
public class SchoolController_BCK : MonoBehaviour
{
    public bool _isObjective;
	public SchoolChild_BCK[] _childPrefab;			// Assign prefab with SchoolChild script attached
	...
	public List<SchoolChild_BCK> _roamers;
    ...
    public void AddFish(int amount)
    {
        ...
        for (int i = 0; i < amount; i++)        
		{
            ...
            SchoolChild_BCK obj = (SchoolChild_BCK)Instantiate(_childPrefab[child]);
	...
	public void RemoveFish(int amount){
        SchoolChild_BCK dObj = _roamers[_roamers.Count-1];
